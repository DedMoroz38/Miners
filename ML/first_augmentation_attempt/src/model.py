...
Identical to the baseline (first_classification_attempt): the point of this
experiment is to isolate the effect of *augmentation*, so the model is held
fixed. See that folder's README for why a classifier (not U-Net / YOLO).
